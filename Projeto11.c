...
void CadastraCasa(tCasa *casas){
    ...
    fgets(casas[count - 1].dados.disponivelAluVen, 2, stdin);
    casas[count - 1].dados.disponivelAluVen[strlen(casas[count - 1].dados.disponivelAluVen) - 1] = '\0';
...
void CadastraApartamento(tApartamento *apartamentos){
    ...
    fgets(apartamentos[count - 1].dado.disponivelAluVen, 2, stdin);
    apartamentos[count - 1].dado.disponivelAluVen[strlen(apartamentos[count - 1].dado.disponivelAluVen) - 1] = '\0';

    printf("Digite a area do apartameno: ");
...
void CadastraTerreno(tTerreno *terrenos){
    ...
    fgets(terrenos[count - 1].dadoo.disponivelAluVen, 2, stdin);
    terrenos[count - 1].dadoo.disponivelAluVen[strlen(terrenos[count - 1].dadoo.disponivelAluVen) - 1] = '\0';
...
void ImoveisDisponiveis(tcasa *casas, tApartamento *apartamentos, tTerreno *terrenos){
    ...
    for(i=0; i<100; i++){
        if(casas[i].dados.disponivelAluVen != N){
